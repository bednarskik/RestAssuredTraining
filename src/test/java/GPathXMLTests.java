...
public class GPathXMLTests extends VideoGameConfig {
    ...
    public void getListOfXmlNodes() {
        ...
        System.out.println(allResults.get(2).get("name").toString()); //with breakpoint here we can debug and see all results captured
    }
    ...
    public void getListOfXmlNodesByFindAllOnAttribute() {
        ...
        System.out.println(allDrivingGames.get(0).get("name").toString()); //with breakpoint here we can debug and see all results captured
    }
